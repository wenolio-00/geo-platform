...
- default to `candidate_queries = 40` when operators do not provide a concrete value;
- allocate matrix-cell counts with the embedded generation weight formula before selecting templates;
